...
def save_processed_dataset(chunk_size=2000):
    ...
    path_to_save = ProjectUtils.get_preprocessed_pubmed_json_data_path()
...
if __name__ == '__main__':
    ...
    DatabaseUtils.create_and_store_embeddings(
        GEMINI_EMBEDDING_MODEL, GEMINI_EMBEDDING_MODEL_NAME, Distance.COSINE, 'gemini-760-cosine')
    print('Saved gemini vectors in database (chunk_size = 760, distance_metric = cosine similarity)')

    # save vectors of preprocessed dataset created by gemini api, chunk_size 760
    DatabaseUtils.create_and_store_embeddings(
        GEMINI_EMBEDDING_MODEL, GEMINI_EMBEDDING_MODEL_NAME, Distance.EUCLID, 'gemini-760-euclidean')
    print('Saved gemini vectors in database (chunk_size = 760, distance_metric = cosine similarity)')

    # # save vectors of preprocessed dataset created by gemini api, chunk_size 760
    # DatabaseUtils.create_and_store_embeddings(
    #     WORD2VEC_EMBEDDING_MODEL, WORD2VEC_EMBEDDING_MODEL_NAME, Distance.COSINE, 'word2vec-760-cosine')
    # print('Saved word2vec vectors in database (chunk_size = 760, distance_metric = cosine similarity)')
    #
    # # save vectors of preprocessed dataset created by gemini api, chunk_size 760
    # DatabaseUtils.create_and_store_embeddings(
    #     WORD2VEC_EMBEDDING_MODEL, WORD2VEC_EMBEDDING_MODEL_NAME, Distance.EUCLID, 'word2vec-760-euclidean')
    # print('Saved word2vec vectors in database (chunk_size = 760, distance_metric = cosine similarity)')
    ...
    DatabaseUtils.create_and_store_embeddings(
        GEMINI_EMBEDDING_MODEL, GEMINI_EMBEDDING_MODEL_NAME, Distance.COSINE, 'gemini-2000-cosine')
    print('Saved gemini vectors in database (chunk_size = 2000, distance_metric = cosine similarity)')

    # save vectors of preprocessed dataset created by gemini api, chunk_size 2000
    DatabaseUtils.create_and_store_embeddings(
        GEMINI_EMBEDDING_MODEL, GEMINI_EMBEDDING_MODEL_NAME, Distance.EUCLID, 'gemini-2000-euclidean')
    print('Saved gemini vectors in database (chunk_size = 380, distance_metric = cosine similarity)')

    # # save vectors of preprocessed dataset created by gemini api, chunk_size 2000
    # DatabaseUtils.create_and_store_embeddings(
    #     WORD2VEC_EMBEDDING_MODEL, WORD2VEC_EMBEDDING_MODEL_NAME, Distance.COSINE, 'word2vec-2000-cosine')
    # print('Saved word2vec vectors in database (chunk_size = 2000, distance_metric = cosine similarity)')
    #
    # # save vectors of preprocessed dataset created by gemini api, chunk_size 2000
    # DatabaseUtils.create_and_store_embeddings(
    #     WORD2VEC_EMBEDDING_MODEL, WORD2VEC_EMBEDDING_MODEL_NAME, Distance.EUCLID, 'word2vec-2000-euclidean')
    # print('Saved word2vec vectors in database (chunk_size = 380, distance_metric = cosine similarity)')
